...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScientificCalcFragment scientificCalcFragment = new ScientificCalcFragment();
        FragmentManager fragmentManager = getSupportFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.container, scientificCalcFragment)
                .commit();
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.sqrt:
                if (e2.length() != 0) {
                    ...
                    toggleMode=(int)toggle.getTag();
                    if(toggleMode==1)
                        e2.setText(text + " " + getString(R.string.sqrt));
                    else if(toggleMode==2)
                        e2.setText(text + " " + getString(R.string.cuberoot));
                    else
                        e2.setText(text + " " + getString(R.string.inverse));
                }
                break;
            ...
            case R.id.square:
                if (e2.length() != 0) {
                    text = e2.getText().toString();
                    if(toggleMode==2)
                        e2.setText(text + " " + getString(R.string.cube));
                    else
                        e2.setText(text + " " +  getString(R.string.square));
                }
                break;
            ...
            case R.id.log:
                if (e2.length() != 0) {
                    text = e2.getText().toString();
                    if(toggleMode==2)
                        e2.setText(text + " " + getString(R.string.naturalLog));
                    else
                        e2.setText(text + " " + getString(R.string.log));
                }
                break;
            ...
            case R.id.sin:
                if (e2.length() != 0) {
                    text = e2.getText().toString();
                    if(toggleMode==1)
                        e2.setText(text + " " + getString(R.string.sin));
                    else if(toggleMode==2)
                        e2.setText(text + " " + getString(R.string.sininv));
                    else
                        e2.setText(text + " " + getString(R.string.hyperbolicSine));
                    /*if(angleMode==1)
                    {
            ...
            case R.id.cos:
                if (e2.length() != 0) {
                    text = e2.getText().toString();
                    if(toggleMode==1)
                        e2.setText(text + " " + getString(R.string.cos));
                    else if(toggleMode==2)
                        e2.setText(text + " " + getString(R.string.cosinv));
                    else
                        e2.setText(text + " " + getString(R.string.hyperbolicCosine));
                    /*if(angleMode==1)
                    {
                        double angle=Math.toRadians(new ExtendedDoubleEvaluator().evaluate(text));
                        if(toggleMode==1)
            ...
            case R.id.tan:
                if (e2.length() != 0) {
                    text = e2.getText().toString();
                    if(toggleMode==1)
                        e2.setText(text + " " + getString(R.string.tan));
                    else if(toggleMode==2)
                        e2.setText(text + " " + getString(R.string.taninv));
                    else
                        e2.setText(text + " " + getString(R.string.hyperbolicTan));
                    /*if(angleMode==1)
                    {
                        double angle=Math.toRadians(new ExtendedDoubleEvaluator().evaluate(text));
                        if(toggleMode==1)
